...
const { register, login, logout, getProfile, handleDecline, handleVerify, getAllVerifiedRestaurents, getAllPendingRestaurents, getAllOrderDetails } = require('../controllers/admin')
